...
```
$ git clone https://github.com/HannaMeressa/covid-19.git
$ mv covid-19-prediction covid
$ chmod +x run.sh
$ ./run.sh
```
To access your server go to $HOSTNAME/covid/ from your browser. The webapp is hosted on https://HannaMeressa/covid-19/ where graphs get updated daily based on new data.
...
[Shreshth Tuli](https://www.github.com/HannaMeressa) (hanna.me2010@gmail.com)
